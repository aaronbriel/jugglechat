...
"""
Contains configuration variables for the celery instance
"""
...
NO_ANSWER_RESPONSE = "I'm sorry, but I don't seem to have a solid answer for that.. :("
THRESHOLD = 0.6

# urls
BROKER_URL = 'redis://localhost:6379/0'
BACKEND_URL = 'redis://localhost:6379/1'
QA_URL = 'http://127.0.0.1:8000/models/1/doc-qa'
FAQ_URL = 'http://127.0.0.1:8000/models/2/faq-qa' # had 1
ABSUM_URL = 'http://127.0.0.1:8000/summarize'
RASA_CORE_URL = 'http://localhost:5005/webhooks/rest/webhook'
RASA_NLP_URL = 'http://localhost:5005/model/parse'

# env vars
COMMAND = os.getenv("COMMAND", "ask")
...
This overview is organized by first presenting a background on coronaviruses and then briefly describes the emergence, transmission, symptoms, prevention and treatment of COVID-19. The rest of the document reviews COVID-19 IPC priorities, in non-US healthcare settings.
...
COVID-19: IPC Priorities
	...
	a.	Screening/Triage at initial healthcare facility encounter and rapid implementation of source control
	b.	Limiting the entry of healthcare workers and/or visitors with suspected or confirmed COVID-19
	2.	Immediate isolation and referral for testing
	a.	Group patients with suspected or confirmed COVID-19 separately
	b.	Test all suspected patients for COVID-19
	3.	Safe clinical management
	a.	Immediate identification of inpatients and healthcare workers with suspected COVID-19
